...
biocLite(c("Biostrings", "biomaRt", "BSgenome","QDNAseq","exomeCopy",
        ...
        "wakefield","VariantAnnotation","limma","dplyr","ggplot2","tidyr","readr","GenVisR","circlize","RColorBrewer","circlize", "InteractionSet","mclust","devtools","SomaticSignatures","deconstructSigs"))
