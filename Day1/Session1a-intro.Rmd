...
- Workshop dinner on Thursday night at Christ's College
    ...
    + Please let us know a.s.ap if you won't be coming!
...
- Installing software can be challenging, even for those with many years of experience
- The [*Docker*](http://www.docker.com/) platform is becoming an increasingly-popular way of packaging and distributing software
    + The Sanger institute have wrapped their genome analysis pipeline in a [docker container](https://github.com/cancerit/cgpbox)
    + We have created one too for other software required for the course

![](https://pbs.twimg.com/profile_images/378800000124779041/fbbb494a7eef5f9278c6967b6072ca3e_400x400.png)

- On a Mac / Windows machine, you'll need to download the Docker software
- After that it's just a single command to get all software you need
    + in theory at least (!)
